...
const page = () => {
  ...
  return (
    ...
    <Row>
        ...
        <Card style={{ boxShadow:"0px 0px 56px 0px #00260314",backgroundColor:"#FFFFFF", }} className='border-rounded'>      
    <Card.Body>
  ...
  <Form.Check.Input style={{padding:"10px",border:"2px solid gray"}}  />
    ...
    <button style={{width:"100%",padding:"15px",borderRadius:"5px",border:"none",backgroundColor:"#00283D",color:"#FFFFFF",fontSize:"14px",fontWeight:"bold"}} className='mt-3'>Sign Up</button>
  <button className='mt-3' style={{width:"100%",padding:"15px",borderRadius:"5px",border:"none",backgroundColor:"#00283D",color:"#FFFFFF",fontSize:"14px",fontWeight:"bold"}}>Sign Up with <BsGoogle/> </button>
    ...
    <div className='d-flex justify-content-center mt-4'>
        ...
        <Link href={"/signin"}  className="ms-2" style={{ color: "#1A1A1A", fontSize: "14px" }}>Login</Link>
