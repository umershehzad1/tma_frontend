...
const page = () => {
    ...
    <Container style={{paddingBottom:"60px"}}>
      ...
      <Card.Body>
        <Card.Title className='text-center'>
            <h1 className='mb-4' style={{fontWeight:"bold",}}>Sign In</h1>
        </Card.Title>
        <Form>
  ...
  <Row>
    ...
    <Form.Check.Label style={{textAlign:"center",paddingLeft:"5px",paddingTop:"3px",color:"#666666"}}>Remember me</Form.Check.Label>
    </div>
  </Col>
  <Col lg = {6}>
    <p style={{textAlign:"end", color:"#666666"}}>Forgot Password</p>
  </Col>
  </Row>

  <button style={{width:"100%",padding:"15px",borderRadius:"5px",border:"none",backgroundColor:"#00283D",color:"#FFFFFF",fontSize:"14px",fontWeight:"bold"}}>Login</button>
  <button className='mt-3' style={{width:"100%",padding:"15px",borderRadius:"5px",border:"none",backgroundColor:"#00283D",color:"#FFFFFF",fontSize:"14px",fontWeight:"bold"}}>Sign Up with <BsGoogle/> </button>
    ...
    <div className='d-flex justify-content-center mt-4'>
        <p style={{color:"#666666",fontSize:"14px"}}>Dont't have account?</p>
        <p style={{color:"#1A1A1A", fontSize:"14px"}}>Register</p>
